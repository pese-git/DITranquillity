...
# С чего начать?
Начать стоит со страницы [Быстрый старт](quick_start.md#Быстрый-старт). На ней описаны базовые возможности библиотеки, и способы установки.
Для лучшего понимания терминологии стоит прочитать [Словарик](glossary.md#Словарик).

Для полного понимания возможностей библиотеки, ниже описаны все возможности со ссылками на соответствующие страницы документации.

# Возможности

* Поддержка чистых Swift типов
* [Внедрение зависимостей через: метод инициализации, свойства, метод](injection.md)
